...
void save_sub(const array<uint8_t, 5000>& assigned_day, double score) {
    ...
    char filename[500];
    sprintf(filename, "./mission/random_from_scratch/submission_%.3f.csv", score);
...
void stochastic_product_search(Index index, ExitFunction fn) { // 15'360'000it/s  65ns/it  0.065µs/it
    ...
    cout << " original score is : " << best_local_score << endl;
    ...
    for (; fn();) {
        ...
        for (int k = 0; k < BEST_N; ++k) {
            ...
            for (const auto& change : changes) {
                ...
                if (score < best_local_score) {
                    ...
                    best_change = change;
                    cout << "found a better score: " << best_local_score << endl;
        ...
        cout<<"round_num: "<< round_num << " cost time: " << totaltime << " seconds " << " found_better: " << found_better << endl;
    }
